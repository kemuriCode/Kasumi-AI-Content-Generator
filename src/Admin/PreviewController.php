...
class PreviewController {
	...
	private function generate_sample_article(): ?array {
		...
		return array(
			...
			'excerpt' => wp_strip_all_tags( $article['excerpt'] ?? wp_trim_words( wp_strip_all_tags( $article['content'] ?? '' ), 40 ) ),
